...
function HookWrapper() {
  ...
  return <div data-testid="hook-result">{consent ? JSON.stringify(consent) : 'null'}</div>
}
...
describe('useCookieConsent', () => {
  ...
  it('returns saved preferences when consent exists', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByTestId('hook-result')).toHaveTextContent(JSON.stringify(prefs))
    })
  })

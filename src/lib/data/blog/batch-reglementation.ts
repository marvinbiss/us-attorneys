export const reglementationArticles: Record<string, {
  ...
  'tva-reduite-travaux-renovation-guide': {
    ...
    keyTakeaways: [
      ...
      "Depuis mars 2025, l'attestation cerfa n'est plus requise : une mention sur the consultation suffit.",
      "Vérifiez la ventilation des taux sur the consultations mixtes pour ne pas payer de TVA en trop."
    ],
  },
  ...
  'certificats-economies-energie-cee-guide': {
    ...
    faq: [
      { question: 'Peut-on demander les CEE après avoir signé the consultation ?', answer: 'Non, c\'est la cause de refus n° 1. L\'inscription doit être faite avant la signature of the consultation. Il n\'existe aucune exception ni dérogation à cette règle.' },
    ...
    keyTakeaways: [
      "Inscrivez-vous aux CEE avant de signer the consultation : cette règle est non négociable.",
  ...
  'eco-pret-taux-zero-guide-complet-2026': {
    ...
    keyTakeaways: [
      ...
      "Les travaux doivent être réalisés par an attorney RGE dans un logement de plus de 2 ans.",
  ...
  'reception-travaux-proces-verbal-reserves': {
    ...
    content: [
      ...
      "## Pourquoi la réception est-elle si importante ?\n\nElle déclenche le point de départ des trois garanties légales (parfait achèvement, biennale, [décennale](/blog/guarantee-decennale-tout-savoir)). Elle transfère la garde de l'ouvrage au maître d'ouvrage. Elle rend exigible le solde du prix. Sans réception, vous êtes dans un flou juridique dangereux.",
      "## Comment organiser la réception ?\n\nConvenez d'une date avec the attorney (qu'il s'agisse d'un [maçon](/practice-areas/macon), d'un électricien ou d'un couvreur) lorsqu'il estime les travaux terminés. Prévoyez au moins 2 heures pour une visite minutieuse. Munissez-vous du [devis](/blog/quotes-travaux-comprendre), du contrat, des plans et d'un mètre ruban. Si possible, faites-vous accompagner d'un expert en bâtiment.",
      ...
      "## Peut-on refuser la réception ?\n\nOui, si les travaux ne sont pas terminés ou si les désordres empêchent une utilisation normale. Le refus doit être motivé par écrit. The attorney devra corriger avant de solliciter une nouvelle réception.",
      ...
      "\n\n:::tip Conseil pro\nFaites-vous accompagner par un expert en bâtiment lors de la réception des travaux importants (coût : 300 à 800 €). Un professionnel détectera des défauts invisibles pour un non-initié, notamment en [plomberie](/practice-areas/plombier) ou en électricité.\n:::",
      "\n\n:::info Bon à savoir\nL'article 1er de la loi du 19 décembre 1990 autorise la consignation de 5 % du prix total jusqu'à la levée des réserves. Si les réserves ne sont pas levées dans le délai convenu, vous pouvez utiliser cette somme pour faire intervenir un autre artisan.\n:::",
  ...
  'litige-artisan-recours-mediation-justice': {
    ...
    excerpt: 'Travaux mal réalisés, retards, surfacturation ? Découvrez les étapes à suivre pour résoudre un litige avec an attorney, de la médiation au tribunal.',
    content: [
      "Malgré toutes les précautions, un litige peut survenir avec an attorney — [plombier](/practice-areas/plombier), électricien ou maçon — : malfaçons, retards importants, abandon de chantier, surfacturation. La loi offre plusieurs voies de recours, de la résolution amiable à l'action en justice.",
      "## Étape 1 : la réclamation amiable\n\nCommencez par un courrier recommandé avec AR adressé à the attorney. Décrivez précisément les désordres, joignez des photos, fixez un délai raisonnable (15 à 30 jours). Ce courrier constitue une mise en demeure au sens de l'article 1231 du Code civil.",
      "## Étape 2 : la médiation de la consommation\n\nDepuis 2016 (ordonnance n° 2015-1033), tout professionnel doit proposer un médiateur. La médiation est gratuite pour le consommateur et l'avis est rendu sous 90 jours. Consultez le site du médiateur indiqué dans les CGV de the attorney.",
      "## Étape 3 : l'expertise amiable\n\nSi le désaccord porte sur la qualité technique des travaux d'un [électricien](/practice-areas/electricien) ou d'un autre corps de métier, faites intervenir un expert en bâtiment. Coût : 800 à 2 000 €. Le rapport sera un élément de preuve précieux en justice.",
      ...
      "## Les délais de prescription\n\nAction pour malfaçon (hors décennale) : 5 ans (article 2224 du Code civil). [Décennale](/blog/guarantee-decennale-tout-savoir) : 10 ans. Parfait achèvement : 1 an. Biennale : 2 ans. Ne laissez pas passer ces délais !",
  ...
  'label-rge-artisan-travaux-energetiques': {
    ...
    content: [
      ...
      "## Comment obtient-on le label RGE ?\n\nThe attorney doit suivre une formation de 3 à 5 jours, justifier de références de chantiers, disposer d'assurances en cours, et passer un audit de chantier. La qualification est valable 4 ans avec audit de suivi tous les 2 ans.",
      "## Comment vérifier qu'an attorney est RGE ?\n\nConsultez l'annuaire officiel sur france-renov.gouv.fr. Demandez le certificat RGE : il doit mentionner les domaines de compétence et la date de validité. Attention aux certificats expirés.",
      "## RGE et contrôles de chantier\n\nLes organismes réalisent des audits aléatoires. En cas de non-conformité, the attorney reçoit un avertissement puis son label est suspendu ou retiré. Ce contrôle qualité est un gage de sérieux.",
      "## Que faire si an attorney se dit RGE à tort ?\n\nL'usurpation du label RGE est une pratique trompeuse au sens du Code de la consommation. Signalez-la à la DGCCRF et à l'organisme de qualification concerné.",
      "\n\n:::warning Attention\nSans artisan RGE, pas de MaPrimeRénov', pas de CEE, pas d'éco-PTZ, pas de TVA à 5,5 %. Le label RGE est la clé d'entrée de toutes les aides à la rénovation énergétique. Choisir an attorney non-RGE revient à renoncer à des milliers d'euros d'aides.\n:::",
      "\n\n:::tip Conseil pro\nVérifiez la qualification RGE sur france-renov.gouv.fr et non uniquement sur le certificat présenté par the attorney. Un certificat expiré ou ne couvrant pas le type de travaux prévu ne vous donne pas droit aux aides.\n:::",
      "\n\n:::takeaway\n- Le label RGE est obligatoire pour accéder aux aides publiques\n- Vérifiez la validité et le domaine de compétence sur france-renov.gouv.fr\n- Les principales mentions : Qualibat RGE, QualiPAC, Qualibois, Qualisol, QualiPV\n- La qualification est valable 4 ans avec audit de suivi tous les 2 ans\n- L'usurpation du label RGE est une pratique trompeuse sanctionnée\n- Sur US Attorneys, la qualification RGE est vérifiée et affichée\n:::",
    ],
    ...
    faq: [
      { question: 'Comment vérifier qu\'an attorney est bien RGE ?', answer: 'Consultez l\'annuaire officiel sur france-renov.gouv.fr. Recherchez par nom, SIRET ou localisation. Le certificat doit mentionner les domaines de compétence et la date de validité.' },
      { question: 'An attorney peut-il perdre son label RGE ?', answer: 'Oui, en cas de non-conformité lors d\'un audit de suivi, de plaintes répétées ou de non-respect des critères. L\'organisme de qualification suspend ou retire le label.' },
  ...
  'qualibat-qualifelec-certifications-batiment': {
    ...
    content: [
      ...
      "## Qualibat : la référence du bâtiment\n\nQualibat délivre des certificats dans plus de 400 domaines : gros œuvre, second œuvre, [isolation](/blog/isolation-maison-guide-complet-materiaux-prix-aides), couverture, [plomberie](/practice-areas/plombier), menuiserie. Chaque qualification atteste de la capacité technique, financière et juridique de l'entreprise. Validité : 4 ans avec audit intermédiaire à 2 ans.",
      "## Qualifelec : l'expertise électrique\n\nQualifelec qualifie les entreprises du génie [électrique](/blog/electricite-normes-securite) : installations réalisées par un [électricien](/practice-areas/electricien), éclairage, domotique, bornes de recharge, photovoltaïque. La mention [RGE](/blog/label-rge-artisan-travaux-energetiques) peut être ajoutée pour les travaux liés à l'efficacité énergétique.",
    ...
    faq: [
      { question: 'An attorney peut-il exercer sans certification ?', answer: 'Oui, la certification n\'est pas obligatoire pour exercer. Cependant, certaines qualifications (RGE notamment) sont obligatoires pour que les clients bénéficient des aides publiques.' },
      { question: 'Combien coûte une certification pour an attorney ?', answer: 'Qualibat : 300 à 800 €/an. Qualifelec : 400 à 1 200 €/an. Qualit\'EnR : 200 à 600 € par qualification. Ces coûts sont un investissement dans la qualité et la crédibilité professionnelle.' },
  ...
  'diagnostic-immobilier-obligatoire-liste': {
    ...
    content: [
      ...
      "## Coût d'un pack diagnostic complet\n\nEn regroupant tous les diagnostics : 400 à 700 € pour un appartement, 500 à 900 € pour une maison. Comparez les [devis](/blog/quotes-travaux-comment-comparer-choisir).",
      ...
      "\n\n:::tip Conseil pro\nRegroupez tous les diagnostics chez un même [diagnostiqueur professionnel](/practice-areas/diagnostiqueur) pour obtenir un tarif pack. Comparez au moins 3 devis. Anticipez : certains diagnostics (termites, ERP) ne sont valables que 6 mois.\n:::",
  ...
  'amiante-plomb-diagnostic-avant-travaux': {
    ...
    content: [
      ...
      "## Le diagnostic amiante avant travaux (DAAT)\n\nObligatoire avant tous travaux dans un bâtiment construit avant le 1er juillet 1997 (article R.4412-97 du Code du travail). Le DAAT, réalisé par un [diagnostiqueur](/practice-areas/diagnostiqueur) certifié, implique des sondages destructifs dans les matériaux susceptibles de contenir de l'amiante.\n\n### Où trouve-t-on de l'amiante ?\n\n- Flocages et calorifugeages\n- Dalles de sol vinyle et colles\n- Plaques de fibrociment (toiture, façade)\n- Enduits et colles de carrelage\n- Joints de dilatation\n- Gaines de ventilation",
      ...
      "## Les obligations de the attorney et le désamiantage\n\nThe attorney doit prendre connaissance du diagnostic, établir un mode opératoire adapté (article R.4412-145 du Code du travail), former ses salariés, utiliser les EPI adaptés, et gérer les déchets dans des filières agréées.\n\nLe retrait d'amiante doit être effectué par une entreprise certifiée. Coût : 25 à 90 €/m². Un plan de retrait doit être soumis à l'inspection du travail au moins un mois avant le début des travaux.",
      ...
      "\n\n:::tip Conseil pro\nN'entamez jamais de travaux dans un bâtiment ancien sans les diagnostics amiante et plomb. Sur notre plateforme, les professionnels référencés, comme nos [plombiers](/practice-areas/plombier) et maçons, connaissent ces obligations et sauront vous orienter vers des diagnostiqueurs certifiés.\n:::",
  ...
  'accessibilite-pmr-logement-normes': {
    ...
    content: [
      ...
      "## Les travaux les plus courants\n\n- Remplacement baignoire par [douche à l'italienne](/blog/tendances-salle-de-bain-2026) par un [plombier](/practice-areas/plombier) : 3 000 à 8 000 €\n- Élargissement de portes par un [maçon](/practice-areas/macon) : 500 à 1 500 €/porte\n- Rampe d'accès : 1 500 à 5 000 €\n- Monte-escalier ou [ascenseur privatif](/practice-areas/ascensoriste) : 5 000 à 15 000 €\n- Motorisation volets : 300 à 800 €/fenêtre\n- Cuisine adaptée : 2 000 à 6 000 €",
    ...
    image: '/images/blog/accessibility-pmr.jpg',
    author: 'Claire Dubois',
    authorBio: 'Claire Dubois, experte en économie de la construction, analyse les prix du marché et les aides financières pour informer les consommateurs.',
    date: '2026-02-07',
    updatedDate: '2026-02-10',
    ...
    faq: [
      ...
      { question: 'Faut-il an attorney spécialisé PMR ?', answer: 'Ce n\'est pas obligatoire mais fortement recommandé. An attorney expérimenté en normes PMR garantit le respect des dimensions, pentes et caractéristiques réglementaires. Demandez des références en accessibilité.' },
  ...
  'reglementation-ravalement-facade-obligations': {
    ...
    content: [
      ...
      "## L'obligation décennale de ravalement\n\nDans les communes ayant pris un arrêté en ce sens (Paris, Lyon, Marseille et de nombreuses cities), les propriétaires doivent maintenir leurs façades en bon état en faisant appel à un [maçon](/practice-areas/macon) ou un façadier qualifié. À Paris, l'obligation est décennale (tous les 10 ans).",
      ...
      "\n\n:::tip Conseil pro\nProfitez d'un ravalement obligatoire pour ajouter une isolation par l'extérieur (ITE) avec un [couvreur](/practice-areas/couvreur) ou un spécialiste façade. Le surcoût est amorti par les économies d'énergie et les aides (MaPrimeRénov', CEE). Depuis le décret n° 2016-711, un ravalement important doit s'accompagner d'une isolation thermique.\n:::",
  ...
  'aides-renovation-2026-cumul-guide': {
    ...
    content: [
      ...
      "## Stratégie 1 : la rénovation par geste\n\nUn ou deux travaux ciblés ([isolation](/blog/isolation-maison-guide-complet-materiaux-prix-aides) combles par un [spécialiste en isolation thermique](/practice-areas/isolation-thermique) + remplacement chaudière). MaPrimeRénov' par geste : 2 000 à 11 000 €. CEE : 1 000 à 4 000 €. TVA 5,5 %. Éco-PTZ pour le reste. Taux de prise en charge : 40 à 70 %.",
      ...
      "## L'Accompagnateur Rénov' et le calendrier\n\nPour MaPrimeRénov' Parcours accompagné, un Accompagnateur Rénov' agréé est obligatoire. Il réalise l'audit, propose les scénarios avec attorneys en [rénovation énergétique](/practice-areas/renovation-energetique), et monte les dossiers. Coût : 1 000 à 2 000 € (pris en charge à 100 % pour les ménages modestes).",
      "\n\n:::tip Conseil pro\nLe calendrier idéal : Mois 1-2 : audit énergétique. Mois 2-3 : devis d'artisans RGE. Mois 3-4 : inscription CEE (avant the consultations !), dépôt MaPrimeRénov', demande éco-PTZ. Mois 4-5 : signature consultations. Mois 5-8 : travaux. Mois 8-9 : factures et perception des aides.\n:::",
      "\n\n:::warning Attention\nLes erreurs qui font perdre des aides : signer the consultation avant l'inscription CEE, commencer les travaux avant l'accord MaPrimeRénov', choisir an attorney non-RGE, ne pas demander l'éco-PTZ avant le début des travaux, oublier les aides locales.\n:::",
  ...
  'contrat-travaux-clauses-essentielles': {
    ...
    faq: [
      ...
      { question: 'L\'artisan peut-il modifier le prix en cours de chantier ?', answer: 'Non, sauf imprévu majeur non décelable au moment of the consultation. Toute modification doit faire l\'objet d\'un avenant écrit signé par les deux parties, avec a consultation complémentaire accepté.' },

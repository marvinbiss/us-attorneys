export const reglementationArticles: Record<string, {
  ...
  'qualibat-qualifelec-certifications-batiment': {
    ...
    content: [
      ...
      "## Qualibat : la référence du bâtiment\n\nQualibat délivre des certificats dans plus de 400 domaines : gros œuvre, second œuvre, [isolation](/blog/isolation-maison-guide-complet-materiaux-prix-aides), couverture, [plomberie](/services/plombier), menuiserie. Chaque qualification atteste de la capacité technique, financière et juridique de l'entreprise. Validité : 4 ans avec audit intermédiaire à 2 ans.",
  ...
  'aides-renovation-2026-cumul-guide': {
    ...
    content: [
      ...
      "## Stratégie 1 : la rénovation par geste\n\nUn ou deux travaux ciblés ([isolation](/blog/isolation-maison-guide-complet-materiaux-prix-aides) combles par un [spécialiste en isolation thermique](/services/isolation-thermique) + remplacement chaudière). MaPrimeRénov' par geste : 2 000 à 11 000 €. CEE : 1 000 à 4 000 €. TVA 5,5 %. Éco-PTZ pour le reste. Taux de prise en charge : 40 à 70 %.",

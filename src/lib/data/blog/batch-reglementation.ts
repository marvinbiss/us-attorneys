export const reglementationArticles: Record<string, {
  ...
  'reception-travaux-proces-verbal-reserves': {
    ...
    content: [
      ...
      "## Comment organiser la réception ?\n\nConvenez d'une date avec l'artisan (qu'il s'agisse d'un [maçon](/practice-areas/macon), d'un électricien ou d'un couvreur) lorsqu'il estime les travaux terminés. Prévoyez au moins 2 heures pour une visite minutieuse. Munissez-vous du [devis](/blog/quotes-travaux-comprendre), du contrat, des plans et d'un mètre ruban. Si possible, faites-vous accompagner d'un expert en bâtiment.",
  ...
  'litige-artisan-recours-mediation-justice': {
    ...
    content: [
      "Malgré toutes les précautions, un litige peut survenir avec un artisan — [plombier](/practice-areas/plombier), électricien ou maçon — : malfaçons, retards importants, abandon de chantier, surfacturation. La loi offre plusieurs voies de recours, de la résolution amiable à l'action en justice.",
  ...
  'aides-renovation-2026-cumul-guide': {
    ...
    content: [
      ...
      "## L'Accompagnateur Rénov' et le calendrier\n\nPour MaPrimeRénov' Parcours accompagné, un Accompagnateur Rénov' agréé est obligatoire. Il réalise l'audit, propose les scénarios avec des artisans en [rénovation énergétique](/practice-areas/renovation-energetique), et monte les dossiers. Coût : 1 000 à 2 000 € (pris en charge à 100 % pour les ménages modestes).",

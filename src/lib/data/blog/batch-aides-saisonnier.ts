...
export const aidesSaisonnierArticles: Record<string, BlogArticle> = {
  'maprimerenovv-guide-complet-2026': {
    ...
    content: [
      ...
      "### VMC et ventilation",
      "L'installation d'une **VMC double flux** est éligible dans le cadre du parcours accompagné. Comptez un coût de 4 000 à 8 000 € pour une installation complète. La prise en charge peut atteindre 90 % pour les ménages Bleu. Un [chauffagiste](/services/chauffagiste) ou un spécialiste CVC certifié RGE peut réaliser cette installation.",

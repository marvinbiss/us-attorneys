...
export const guidesDiversArticles: Record<string, BlogArticle> = {
  'diy-travaux-soi-meme-ou-artisan': {
    ...
    content: [
      ...
      ':::tip Conseil\nSi vous faites appel à un [plombier-chauffagiste](/practice-areas/plombier) pour des travaux touchant au gaz, exigez systématiquement son attestation de capacité PG. C\'est la garantie qu\'il est habilité à intervenir sur les installations gaz.\n:::',
  ...
  'preparer-maison-revente-travaux-rentables': {
    ...
    content: [
      ...
      ':::tip MaPrimeRénov\' et revente\nVous pouvez bénéficier de MaPrimeRénov\' même si vous prévoyez de vendre dans les mois qui suivent les travaux. Il n\'y a **aucune obligation de durée de détention** après les travaux. Faites appel à un [artisan RGE](/practice-areas/) (Reconnu Garant de l\'Environnement) pour être éligible aux aides.\n:::',

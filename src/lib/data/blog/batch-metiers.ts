export const metiersArticles: Record<string, {
  ...
  "metier-electricien-formations-certifications": {
    ...
    content: [
      "L'électricien est un artisan incontournable du bâtiment, dont le rôle ne cesse de s'élargir avec la transition énergétique, la domotique et l'électromobilité. Bornes de recharge, panneaux photovoltaïques, systèmes de gestion intelligente de l'énergie : le métier se transforme en profondeur. Tour d'horizon complet. Si vous cherchez un professionnel, consultez notre annuaire d'[électriciens certifiés](/services/electricien).",
      "## Les formations initiales",

export const projetsArticles: Record<string, {
  ...
  'amenager-jardin-paysagiste-guide': {
    ...
    content: [
      ...
      "Listez vos priorités : espace détente, coin repas, aire de jeux pour les enfants, potager, piscine, massifs fleuris. Évaluez l\'ensoleillement de chaque zone, la nature du sol (argileux, sableux, calcaire) et l\'exposition au vent. Un jardin réussi combine esthétique, fonctionnalité et facilité d\'entretien.",
  ...
  'remplacer-fenetres-guide-performances': {
    ...
    content: [
      ...
      "Le remplacement des fenêtres est l\'occasion de revoir les volets. Volets roulants en aluminium (motorisés) : 300 à 800 euros par fenêtre. Volets battants en aluminium : 200 à 500 euros par fenêtre. Persiennes : 300 à 600 euros. Les volets roulants motorisés avec coffre intégré offrent une isolation complémentaire (Rw de +3 dB).",

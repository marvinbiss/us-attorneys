...
import { IdentitySection } from '@/components/attorney-dashboard/profile/IdentitySection'
import { ContactSection } from '@/components/attorney-dashboard/profile/ContactSection'
import { LocationSection } from '@/components/attorney-dashboard/profile/LocationSection'
import { AboutSection } from '@/components/attorney-dashboard/profile/AboutSection'
import { ServicesPricingSection } from '@/components/attorney-dashboard/profile/ServicesPricingSection'
import { QualificationsSection } from '@/components/attorney-dashboard/profile/QualificationsSection'
import { AvailabilitySection } from '@/components/attorney-dashboard/profile/AvailabilitySection'
import { PreferencesSection } from '@/components/attorney-dashboard/profile/PreferencesSection'
import { FaqSection } from '@/components/attorney-dashboard/profile/FaqSection'
import { AvatarSection } from '@/components/attorney-dashboard/profile/AvatarSection'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <AttorneySidebar activePage="profile" publicUrl={showPublicUrl} />

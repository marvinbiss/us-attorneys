...
import { BAROMETRE_REGIONS } from '@/lib/price-index/constants'
...
const canonicalUrl = `${SITE_URL}/price-index/regions`
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {BAROMETRE_REGIONS.map((region) => {
              ...
              return (
                <Link
                  key={region.slug}
                  href={`/price-index/regions/${region.slug}`}

...
import { getNationalStats, getTopMetiers, getTopVilles } from '@/lib/price-index/queries'
import { getBarometreMetierBySlug } from '@/lib/price-index/constants'

// ---------------------------------------------------------------------------
// Metadata
// ---------------------------------------------------------------------------

const canonicalUrl = `${SITE_URL}/price-index`
...
const faqItems = [
  ...
  },
  {
    ...
    answer: `Oui, les données sont accessibles via notre API publique gratuite (/api/v1/docs). La seule condition est de mentionner la source avec un lien vers ${SITE_URL}/price-index.`,
  },
  {
...
export default async function BarometrePage() {
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Accueil', url: '/' },
    { name: 'Baromètre des Artisans', url: '/price-index' },
  ])
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Top 10 des cities</h2>
                <p className="text-gray-600 mt-1">Les cities avec le plus grand nombre d&apos;artisans</p>
              </div>
              <Link
                href="/price-index/regions"
                className="hidden sm:inline-flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-800"
              >
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-8 md:p-12 text-white">
            ...
            <div className="bg-slate-950/50 rounded-lg p-4 font-mono text-sm text-slate-300 mb-6 overflow-x-auto">
              <code>
                Source : &lt;a href=&quot;{SITE_URL}/price-index&quot;&gt;{SITE_NAME} — Baromètre des Artisans&lt;/a&gt;
              </code>
            </div>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="bg-gray-50 rounded-xl border border-gray-200 p-6 text-left mb-6">
                <p className="font-mono text-sm text-gray-700 mb-2">
                  ...
                  /api/v1/pricing?metier=plombier&amp;ville=paris
                </p>

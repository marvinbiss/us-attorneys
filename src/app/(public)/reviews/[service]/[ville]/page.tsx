...
import { getLocationBySlug, formatNumber } from '@/lib/data/commune-data'
...
async function getTopProviders(cityName: string, _specialtySlug: string): Promise<AvisProvider[]> {
  if (IS_BUILD) return []
  try {
...
async function getRecentReviews(attorneyIds: string[]): Promise<AvisReview[]> {
  if (IS_BUILD || attorneyIds.length === 0) return []
  try {
    const { createAdminClient } = await import('@/lib/supabase/admin')
    const supabase = createAdminClient()
...
export async function generateMetadata({
  ...
  const villeData = getCityBySlug(ville)
  ...
  const canonicalUrl = `${SITE_URL}/reviews/${service}/${ville}`
...
export default async function AvisServiceVillePage({
  ...
  const reviews = await getRecentReviews(attorneyIds)
  ...
  // Provider map keyed by user_id (= attorney_id in reviews) for review display
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: villeData.name, url: `/reviews/${service}/${villeSlug}` },
  ])
  ...
  const reviewFaqItems = [
    ...
    },
    {
      ...
      answer: `À ${villeData.name} (${villeRegion}), les tarifs d'un ${tradeLower} varient de ${minPrice} à ${maxPrice} ${trade.priceRange.unit}. Ces prix sont ajustés selon le coût de la vie régional. Demandez plusieurs devis pour comparer.`,
    },
    {
  ...
  const reviewSchema: Record<string, unknown> = {
    ...
    description: `Consultez les avis et recommandations pour choisir un ${tradeLower} de confiance à ${villeData.name} (${villeData.stateName}). Prix : ${minPrice}–${maxPrice} ${trade.priceRange.unit}.`,
    url: `${SITE_URL}/reviews/${service}/${villeSlug}`,
    provider: {
      '@type': 'Organization',
  ...
  const nearbyCitiesByPop = [...cities]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-28 md:pt-14 md:pb-36">
          <Breadcrumb
            items={[
              ...
              { label: `Avis ${tradeLower}`, href: `/reviews/${service}` },
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto mb-4">
              ...
              &agrave; {villeData.name} ({villeData.stateName}).
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {topProviders.map((provider, i) => (
                <Link
                  key={provider.id}
                  href={`/practice-areas/${service}/${villeSlug}/${provider.stable_id}`}
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="space-y-4">
              {reviews.slice(0, 5).map(review => {
                const provider = providerMap.get(review.attorney_id)
                return (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-heading text-2xl font-bold text-gray-900 mb-6">
            Avis {tradeLower} dans d&apos;autres cities
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-heading text-xl font-bold text-gray-900 mb-4">
            Grandes cities &agrave; proximit&eacute;
          </h2>
      ...
      <section className="py-8 border-t">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href={`/pricing/${service}/${villeSlug}`} className="px-4 py-2 bg-emerald-50 text-emerald-800 rounded-lg text-sm font-medium border border-emerald-100 hover:border-emerald-200 transition-colors">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link
                  href={`/emergency/${service}/${villeSlug}`}
                  className="block text-sm text-gray-600 hover:text-blue-600 py-1"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-50 rounded-2xl border border-slate-200 p-6">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              ...
              {villeRegion}). Seul un devis personnalis&eacute; fait foi.{' '}
      ...
      <EstimationWidget context={{
        ...
        pageUrl: `/reviews/${service}/${villeSlug}`,
      }} />

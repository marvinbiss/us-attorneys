      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section className="mb-16">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">{villesDuDepartement.length} villes référencées</p>
              </div>
            </div>
        ...
        {siblingDepts.length > 0 && (
          <section className="mb-16">
            ...
            <div className="flex flex-wrap gap-3">
              {siblingDepts.map((d) => (
                <Link key={d.slug} href={`/departements/${d.slug}/${serviceSlug}`} className="bg-white border border-gray-200 hover:bg-blue-50 hover:border-blue-200 text-slate-700 hover:text-blue-700 px-4 py-2.5 rounded-xl text-sm font-medium transition-colors">
                  {d.name} ({d.code})
                </Link>
              ))}
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div>
              ...
              <div className="space-y-2">
                {villesDuDepartement.slice(0, 6).map((v) => (
                  <Link key={v.slug} href={`/services/${serviceSlug}/${v.slug}`} className="flex items-center gap-2 text-sm text-slate-600 hover:text-blue-600 py-2 transition-colors">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                {regionSlug && (
                  <Link href={`/regions/${regionSlug}/${serviceSlug}`} className="flex items-center gap-2 text-sm text-slate-600 hover:text-blue-600 py-2 transition-colors">
                    <ChevronRight className="w-3 h-3" />

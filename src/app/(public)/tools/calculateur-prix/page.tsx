...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/tools/calculator-prix`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    url: `${SITE_URL}/tools/calculator-prix`,
    type: 'website',
    locale: 'fr_FR',
    images: [
      {
...
export default function CalculateurPrixPage() {
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Accueil', url: '/' },
    { name: 'Outils', url: '/tools/calculator-prix' },
    { name: 'Calculateur de prix', url: '/tools/calculator-prix' },
  ])

...
export const metadata: Metadata = {
  ...
  description: 'Find attorneys in major US cities. Browse lawyers near you, read reviews, and get free consultations.',
  ...
  openGraph: {
    ...
    url: `${SITE_URL}/cities`,
    type: 'website',
    images: [{ url: `${SITE_URL}/opengraph-image`, width: 1200, height: 630, alt: 'US Attorneys — Attorneys by City' }],
  },
  twitter: {
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-10 pb-28 md:pt-14 md:pb-36">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/15 backdrop-blur-sm rounded-full border border-blue-400/25 mb-6">
              ...
              <span className="text-sm font-medium text-white/90">{cities.length}+ cities covered</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Find attorneys in more than {cities.length} cities across the United States.
              Browse qualified lawyers near you.
            </p>
          </div>
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            {/* Departements */}
            <div>
              <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wider mb-4">By state</h3>
              <div className="space-y-2">

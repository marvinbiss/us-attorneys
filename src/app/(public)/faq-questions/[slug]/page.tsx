...
import { getQuestionBySlug, getQuestionSlugs, getQuestionsByCategory } from "@/lib/data/faq"
...
export function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "article",
      url: `${SITE_URL}/faq/${question.slug}`,
    },
    twitter: {
...
export default function QuestionPage({
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: question.question, url: `/faq/${question.slug}` },
  ])
          ...
          <article className="flex-1 max-w-3xl">
            ...
            <div className="mt-10 pt-8 border-t">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                <Link
                  href={`/practice-areas/${question.relatedService}`}
                ...
                <Link
                  href={`/pricing/${question.relatedService}`}
                  className="flex items-center gap-3 p-4 bg-white border rounded-xl hover:border-blue-300 hover:shadow-md transition-all group"
                >
                ...
                <Link
                  href={`/quotes/${question.relatedService}`}
                  className="flex items-center gap-3 p-4 bg-white border rounded-xl hover:border-blue-300 hover:shadow-md transition-all group"
                >

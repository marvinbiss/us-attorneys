...
const services = [
  { label: "Chauffagiste", href: "/practice-areas/chauffagiste", icon: Flame },
  { label: "Électricien", href: "/practice-areas/electricien", icon: Zap },
  { label: "Isolation thermique", href: "/practice-areas/isolation-thermique", icon: Building2 },
  { label: "Pompe à chaleur", href: "/practice-areas/pompe-a-chaleur", icon: Wind },
  { label: "Panneaux solaires", href: "/practice-areas/panneaux-solaires", icon: Sun },
  { label: "Rénovation énergétique", href: "/practice-areas/renovation-energetique", icon: ShieldCheck },
]

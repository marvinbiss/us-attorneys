...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Find an Attorney' }]
        ...
        <section className="mx-auto max-w-5xl px-4 py-12">
          <div className="rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 p-8 text-center text-white md:p-12">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-lg text-blue-100">
              Thousands of verified professionals listed with their credentials. Compare profiles

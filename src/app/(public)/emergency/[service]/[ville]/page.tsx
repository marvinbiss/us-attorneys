...
import { getLocationBySlug, formatNumber, monthName } from '@/lib/data/commune-data'
...
export async function generateMetadata({
  ...
  const titleTemplates = [
    ...
    `${trade.name} urgence ${villeData.name} (${villeData.stateCode})`,
  ]
  ...
  const canonicalUrl = `${SITE_URL}/emergency/${service}/${villeSlug}`
...
export default async function UrgenceServiceVillePage({
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: villeData.name, url: `/emergency/${service}/${villeSlug}` },
  ])
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Breadcrumb
            items={[
              ...
              { label: `${trade.name} urgence`, href: `/emergency/${service}` },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <UrgencyCountdown specialtyName={trade.name} cityName={villeData.name} />
      </div>
                  ...
                  <div className="space-y-3">
                    {commune.part_maisons_pct != null && commune.part_maisons_pct > 60 && (
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-gray-700 text-sm leading-relaxed">
                          Avec <strong>{commune.part_maisons_pct} % de maisons</strong> à {villeData.name}, les urgences de toiture, plomberie extérieure et serrurerie sont plus fréquentes que dans les cities à dominante d&apos;appartements.
                        </p>
                      </div>
                    )}
                    {commune.part_maisons_pct != null && commune.part_maisons_pct <= 60 && (
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link
                  href={`/reviews/${service}/${villeSlug}`}
                  className="block text-sm text-gray-600 hover:text-blue-600 py-1"
                >
                  Avis {tradeLower} à {villeData.name}
                </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-50 rounded-2xl border border-slate-200 p-6">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              ...
              régionales ({villeRegion}). Ils peuvent varier selon la
      ...
      <StickyMobileCTA specialtySlug={service} citySlug={villeSlug} ctaText="Intervention urgente — Devis gratuit" />
      ...
      <EstimationWidget context={{
        ...
        pageUrl: `/emergency/${service}/${villeSlug}`,
      }} />

      <MicroConversions pageType="urgence-ville" specialtySlug={service} cityName={villeData.name} />
    </div>
  )
}

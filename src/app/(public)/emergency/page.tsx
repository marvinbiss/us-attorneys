...
const topEmergencyCities = cities.slice(0, 12)
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              Nos artisans d&apos;urgence interviennent dans plus de 140 cities en France.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            >
              Voir toutes les cities couvertes
              <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {urgencyServices.map((service) => (
                    <Link
                      ...
                      href={`/emergency/${service.slug}/${ville.slug}`}
              ...
              <div key={service.slug}>
                ...
                <div className="space-y-1.5">
                  {cities.slice(0, 6).map((ville) => (
                    <Link key={ville.slug} href={`/emergency/${service.slug}/${ville.slug}`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-1.5">
                {services.slice(0, 10).map((s) => (
                  <Link key={s.slug} href={`/pricing/${s.slug}`}
                    className="flex items-center gap-2 text-sm text-gray-600 hover:text-red-600 py-1 transition-colors">
            ...
            <div>
              ...
              <div className="space-y-1.5">
                ...
                <Link href="/cities" className="flex items-center gap-2 text-sm text-gray-600 hover:text-red-600 py-1 transition-colors">
                  <ChevronRight className="w-3 h-3" /> Toutes les cities
                </Link>
                <Link href="/states" className="flex items-center gap-2 text-sm text-gray-600 hover:text-red-600 py-1 transition-colors">
                ...
                <Link href="/quotes" className="flex items-center gap-2 text-sm text-gray-600 hover:text-red-600 py-1 transition-colors">
                  <ChevronRight className="w-3 h-3" /> Demander un devis
                </Link>
                <Link href="/pricing" className="flex items-center gap-2 text-sm text-gray-600 hover:text-red-600 py-1 transition-colors">
                  <ChevronRight className="w-3 h-3" /> Tarifs artisans
                </Link>
                <Link href="/reviews" className="flex items-center gap-2 text-sm text-gray-600 hover:text-red-600 py-1 transition-colors">
          ...
          __html: JSON.stringify({
            ...
            '@graph': [
              ...
              ...urgencyServices.map((s) => ({
                ...
                availableChannel: {
                  '@type': 'ServiceChannel',
                  serviceUrl: `${SITE_URL}/practice-areas/${s.slug}`,

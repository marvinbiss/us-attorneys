...
export default function AbogadosNotFound() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-8">
          La especialidad legal que busca no existe o ha sido renombrada.
          Por favor, consulte nuestra lista completa de especialidades.
        </p>

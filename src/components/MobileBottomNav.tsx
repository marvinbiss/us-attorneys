...
const navItems: { href: string; icon: typeof Home; label: string; isPrimary?: boolean }[] = [
  ...
  { href: '/practice-areas', icon: Wrench, label: 'Services' },
...
export default function MobileBottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200/80 bg-white/95 pb-[env(safe-area-inset-bottom,0px)] shadow-[0_-4px_20px_rgba(0,0,0,0.08)] backdrop-blur-xl dark:border-gray-700/80 dark:bg-gray-900/95 md:hidden"
          ...
          if (isPrimary) {
            return (
              <Link
                ...
                className="flex h-full min-h-[44px] w-full min-w-[44px] touch-manipulation flex-col items-center justify-center gap-0.5 transition-colors active:scale-95"
              >
                <div className="-mt-5 flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-brand to-brand-dark shadow-lg shadow-brand/30 ring-4 ring-white dark:ring-gray-900">
